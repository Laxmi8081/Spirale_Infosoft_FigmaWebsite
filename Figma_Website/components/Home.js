...
function Home() {
  return (
    <>
      ...
      {/* Dark Area*/}
      <Container>
        <Grid container justifyContent='center' spacing={3} mt={1} mb={4}>
      ...
      <Container>
        ...
        <Grid container justifyContent='center' spacing={3} mt={1} mb={4}>
          ...
          <Grid item lg={6}>
            ...
            <Box mt={1} textAlign='center' className='move'>
              
                <img src={removebg}  alt='' class="img-responsive"  />
      ...
      <Container>
        ...
        <Grid container justify='center' spacing={3} mt={1}>
          <Grid item lg={4} >
            <paper>
              <Card className='cardbody' variant="outlined" sx={{ marginTop: '20px', width: '100%', height: '100%', textAlign: 'center' }}>
                <Box p={3} m={1}>
      ...
      <Box sx={{ color: 'white' }} mt={7} className="dot">
        ...
        <Grid container justifyContent='center' mt={8}>
          ...
          <Grid item lg={3}>
            <paper>
              <Box mt={4} mb={4} ml={2} textAlign='center'>
